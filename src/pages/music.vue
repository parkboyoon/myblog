<template>
  <div class="music-wrap">
    <div v-for="item in nbaList" @click="godetail(item.id)">
      <el-card class="common-card-blog" shadow="hover">
        ...
        <div class="blog-foot">
          ...
          <span class="blog-foot-item"><i class="el-icon-edit"></i> <span>围观: {{item.count}}</span></span>
        </div>
      </el-card>
    </div>
    <div class="clearfloat">
      <el-pagination background layout="prev, pager, next" :current-page="pageNum" @current-change="pagechange" :total="totalPage"></el-pagination>
    </div>
  </div>
</template>
